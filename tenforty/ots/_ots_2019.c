...
/* START of taxsolve_US_1040_2019.c */
float _us_thisversion = 17.01;
...
double _us_L18c = 0.0;
double _us_L18d = 0.0;
double _us_brkpt[4][9] = {{0.0, 9700.0, 39475.0, 84200.0, 160725.0, 204100.0, 510300.0, 9e9}, {0.0, 19400.0, 78950.0, 168400.0, 321450.0, 408200.0, 612350.0, 9e9}, {0.0, 9700.0, 39475.0, 84200.0, 160725.0, 204100.0, 306175.0, 9e9}, {0.0, 13850.0, 52850.0, 84200.0, 160700.0, 204100.0, 510300.0, 9e9}};
...
;  fprintf(outfile, "Review AMT form6251 routine for your situation.\n");
  ...
  amtws2e = absolutev(_us_Sched1[1]);
  _us_amtws[2] = (((amtws2a + amtws2b) + _us_amtws2c) + amtws2e) + _us_amtws2g;
  for (j = 1; j <= 3; j++)
    _us_amtws[4] = _us_amtws[4] + _us_amtws[j];

  if ((_us_status == 3) && (_us_amtws[4] > 733700.0))
  {
    if (_us_amtws[4] > 957100.0)
      _us_amtws[4] = _us_amtws[4] + 55850.0;
    else
      _us_amtws[4] = _us_amtws[4] + (0.25 * (_us_amtws[4] - 733700.0));
...
;      exit(1);
  ...
  if (_us_amtws[6] > 0.0)
  {
    if (((L[6] != 0.0) || (_us_L3a != 0.0)) || ((_us_SchedD[15] > 0.0) && (_us_SchedD[16] > 0.0)))
    {
      ...
      switch (_us_status)
      {
        ...
        case 5:
          _us_amtws[19] = 78750.0;
          break;

        case 1:

        case 3:
          _us_amtws[19] = 39375.0;
          break;

        case 4:
          _us_amtws[19] = 52750.0;
      ...
      if (_us_Do_QDCGTW)
        ...
        _us_amtws[20] = NotLessThanZero(L[11]);
      ...
      {
        case 1:
          _us_amtws[25] = 434550.0;
          break;

        case 3:
          _us_amtws[25] = 244425.0;
          break;

        case 2:

        case 5:
          _us_amtws[25] = 488850.0;
          break;

        case 4:
          _us_amtws[25] = 461700.0;
          break;
...
;          exit(1);
  ...
  _us_amtws[10] = (_us_L12a + _us_Sched2[2]) - _us_Sched3[1];
...
;    fprintf(outfile, " No carry-over loss.\n");
  ...
  ws[1] = _us_LastYearsReturn->fedline[10];
...
void _us_sched_D_tax_worksheet(int _us_status)
{
  ...
  switch (_us_status)
  {
    ...
    case 3:
      ws[19] = smallerof(ws[1], 160725.0);
      break;

    case 2:

    case 5:
      ws[19] = smallerof(ws[1], 321450.0);
      break;

    case 4:
      ws[19] = smallerof(ws[1], 160700.0);
      break;
...
void _us_SocSec_Worksheet()
{
  ...
  ws[1] = _us_L5a;
  ws[2] = 0.5 * ws[1];
  ws[3] = ((((L[1] + L[2]) + L[3]) + L[4]) + L[6]) + _us_Sched1[9];
  ws[4] = _us_L2a;
  ws[5] = (ws[2] + ws[3]) + ws[4];
  for (k = 10; k <= 19; k++)
...
;
  ...
  GetLineF("L4b", &_us_L4b);
  GetLineF("L4c", &_us_L4c);
  GetLineF("L4d", &_us_L4d);
  L[4] = _us_L4b + _us_L4d;
  GetLineF("L5a", &_us_L5a);
  GetLine("L10", &L[10]);
  GetLine("L13a", &_us_L13a);
  GetLine("L17", &L[17]);
  GetLine("L18a", &_us_L18a);
  GetLine("L18b", &_us_L18b);
  GetLine("L18c", &_us_L18c);
  GetLine("L24", &L[24]);
  _us_get_cap_gains();
  ...
  showline_wlabel("L7a", _us_Sched1[9]);
  ...
  showline(6);
  L[7] = (((((L[1] + L[2]) + L[3]) + L[4]) + L[5]) + L[6]) + _us_Sched1[9];
  ...
  showline_wlabel("L8a", _us_Sched1[22]);
  L[8] = L[7] - _us_Sched1[22];
  ...
  switch (_us_status)
  {
    case 1:
      if (_us_under65)
      exemption_threshold = 12200.0;
    else
      exemption_threshold = 13850.0;

      break;

    case 2:
      if (_us_under65 == 2)
      exemption_threshold = 24400.0;
    else
      if (_us_under65 == 1)
      exemption_threshold = 25700.0;
    else
      exemption_threshold = 27000.0;
...
;;    fprintf(outfile, "You may not need to file a return, due to your income level.\n");
  ...
  _us_showschedA(9);
  _us_SchedA[10] = homemort[5] + _us_SchedA[9];
  _us_showschedA(10);
...
;    fprintf(outfile, "	(Itemizations > Std-Deduction, %6.2f > %6.2f)\n", L[9], std_deduc);
  ...
  L[11] = NotLessThanZero(L[8] - _us_L11a);
  showline_wmsg(11, "Taxable Income");
  _us_L12a = _us_TaxRateFunction(L[11], _us_status);
  if (L[11] <= 0.0)
  {
;  }
  else
...
;      fprintf(outfile, "ERROR1: Found '%s' when expecting 'S2_2 or AMTwsXX'\n", labelx);
  ...
  L[12] = _us_Sched2[3] + _us_L12a;
  showline(12);
  _us_Report_bracket_info(L[11], _us_Sched2[3], _us_status);
  L[15] = _us_Sched2[10];
  ...
  GetLine("S3_12", &_us_Sched3[12]);
  showline_wlabelnz("S3_12", _us_Sched3[12]);
  GetLine("S3_13", &_us_Sched3[13]);
  showline_wlabelnz("S3_13", _us_Sched3[13]);
  for (j = 8; j <= 13; j++)
    _us_Sched3[14] = _us_Sched3[14] + _us_Sched3[j];

  showline_wlabelnz("S3_14", _us_Sched3[14]);
  _us_L18d = _us_Sched3[14];
  showline(13);
  ...
  showline(17);
  showline_wlabelnz("L18a", _us_L18a);
  showline_wlabelnz("L18b", _us_L18b);
  showline_wlabelnz("L18c", _us_L18c);
  showline_wlabelnz("L18d", _us_L18d);
  L[18] = ((_us_L18a + _us_L18b) + _us_L18c) + _us_L18d;
...
/* END of taxsolve_US_1040_2019.c */
/* START of taxsolve_US_1040_Sched_C_2019.c */
float _us_c_thisversion = 17.00;
...
/* END of taxsolve_US_1040_Sched_C_2019.c */
/* START of taxsolve_CA_540_2019.c */
float _ca_thisversion = 17.02;
int _ca_status = 0;
...
double _ca_TaxRateFormula(double income, int _ca_status)
{
  ...
  if ((_ca_status == 1) || (_ca_status == 3))
  {
    if (income < 8809.00)
      ...
      if (income < 20883.00)
      tax = 88.09 + (0.02 * (income - 8809.00));
    else
      if (income < 32960.00)
      tax = 329.57 + (0.04 * (income - 20833.00));
    else
      if (income < 45753.00)
      tax = 812.65 + (0.06 * (income - 32960.00));
    else
      if (income < 57824.00)
      tax = 1580.23 + (0.08 * (income - 45753.00));
    else
      if (income < 295373.00)
      tax = 2545.91 + (0.093 * (income - 57824.00));
    else
      if (income < 354445.00)
      tax = 24637.97 + (0.103 * (income - 295373.00));
    else
      if (income < 590742.00)
      tax = 30722.39 + (0.113 * (income - 354445.00));
    else
      tax = 57423.95 + (0.123 * (income - 590742.00));
    ...
    if ((_ca_status == 2) || (_ca_status == 5))
  {
    if (income < 17618.00)
      ...
      if (income < 41766.00)
      tax = 176.18 + (0.02 * (income - 17618.00));
    else
      if (income < 65920.00)
      tax = 659.14 + (0.04 * (income - 41766.00));
    else
      if (income < 91506.00)
      tax = 1625.30 + (0.06 * (income - 65920.00));
    else
      if (income < 115648.00)
      tax = 3160.46 + (0.08 * (income - 91506.00));
    else
      if (income < 590746.00)
      tax = 5091.82 + (0.093 * (income - 115648.00));
    else
      if (income < 708890.00)
      tax = 49275.93 + (0.103 * (income - 590746.00));
    else
      if (income < 1181484.00)
      tax = 61444.76 + (0.113 * (income - 708890.00));
    else
      tax = 114847.88 + (0.123 * (income - 1181484.00));
  ...
  else
  {
    if (income < 17629.00)
      ...
      if (income < 41768.00)
      tax = 176.29 + (0.02 * (income - 17629.00));
    else
      if (income < 53848.00)
      tax = 659.07 + (0.04 * (income - 41768.00));
    else
      if (income < 66636.00)
      tax = 1142.07 + (0.06 * (income - 53848.00));
    else
      if (income < 78710.00)
      tax = 1909.65 + (0.08 * (income - 66636.00));
    else
      if (income < 401705.00)
      tax = 2875.57 + (0.093 * (income - 78710.00));
    else
      if (income < 482047.00)
      tax = 32914.11 + (0.103 * (income - 401705.00));
    else
      if (income < 803410.00)
      tax = 41189.34 + (0.113 * (income - 482047.00));
    else
      tax = 77503.36 + (0.123 * (income - 803410.00));
  ...
  while (!feof(infile))
  {
    ...
    if ((word[0] == 'L') && (strstr(fline, " = ") != 0))
    {
      if (strcmp(word, "L2a") == 0)
        ...
        _ca_grab_line_value(word, fline, &fed_data->fed_L4c);
      else
        if (strcmp(word, "L4d") == 0)
        _ca_grab_line_value(word, fline, &fed_data->fed_L4d);
      else
...
int _ca_main(int argc, char *argv[])
{
  ...
  char *SpouseLastName = "";
  char *socsec;
  double sched540A4d = 0.0;
  double sched540Ab4d = 0.0;
  double sched540Ac4d = 0.0;
...
;  read_line(infile, word);
  ...
  GetLineF("L12", &L[12]);
  L[13] = _ca_PrelimFedReturn.fedl8b;
  showline(13);
  ...
  if (_ca_PrelimFedReturn.fed_L4c != 0.0)
    fprintf(outfile, " SchedCA540_A4d_ = %6.2f\n", _ca_PrelimFedReturn.fed_L4c);

  sched540A4d = _ca_PrelimFedReturn.fed_L4d;
...
/* END of taxsolve_CA_540_2019.c */
/* START of taxsolve_MA_1_2019.c */
float _ma_thisversion = 17.00;
...
/* END of taxsolve_MA_1_2019.c */
/* START of taxsolve_NC_D400_2019.c */
float _nc_thisversion = 17.00;
double _nc_flat_tax_rate = 0.0525;
...
/* END of taxsolve_NC_D400_2019.c */
/* START of taxsolve_NJ_1040_2019.c */
float _nj_thisversion = 17.00;
double _nj_COJ[1000];
double _nj_S[1000];
double _nj_F[1000];
...
;    fprintf(outfile, "Error: unrecognized status '%s'. Must be: Single, Married/joint, Married/sep, Head_of_house, Widow(er)\nExiting.\n", word);
  ...
  showline_wmsg(53, "Total Tax Due");
  GetLine("L54", &L[54]);
...
/* END of taxsolve_NJ_1040_2019.c */
/* START of taxsolve_NY_IT201_2019.c */
float _ny_thisversion = 17.00;
double _ny_A[10];
double _ny_S[10];
int _ny_status = 0;
...
double _ny_TaxRateFunction(double income, int _ny_status)
{
  ...
  switch (_ny_status)
  {
    ...
    case 5:
      ...
      if (income <= 161550.0)
      tax = 2093.0 + (0.0621 * (income - 43000.0));
    else
      if (income <= 323200.0)
      tax = 9455.0 + (0.0649 * (income - 161550.0));
    else
      if (income <= 2155350.0)
      tax = 19946.0 + (0.0685 * (income - 323200.0));
    else
      tax = 145448.0 + (0.0882 * (income - 2155350.0));
    ...
    case 3:
      ...
      if (income <= 80650.0)
      tax = 1042.0 + (0.0621 * (income - 21400.0));
    else
      if (income <= 215400.0)
      tax = 4721.0 + (0.0649 * (income - 80650.0));
    else
      if (income <= 1077550.0)
      tax = 13467.0 + (0.0685 * (income - 215400.0));
    else
      tax = 72524.0 + (0.0882 * (income - 1077550.0));
    ...
    case 4:
      ...
      if (income <= 107650.0)
      tax = 1568.0 + (0.0621 * (income - 32200.0));
    else
      if (income <= 269300.0)
      tax = 6253.0 + (0.0649 * (income - 107650.0));
    else
      if (income <= 1616450.0)
      tax = 16744.0 + (0.0685 * (income - 269300.0));
    else
      tax = 109024.0 + (0.0882 * (income - 1616450.0));
...
;    exit(1);
  ...
  showline(9);
  L[10] = _ny_PrelimFedReturn.fed_L4d;
  showline(10);
  ...
  showline(14);
  L[15] = _ny_PrelimFedReturn.fed_L5b;
  showline(15);
  L[27] = L[15];
  ...
  showline(17);
  if (absolutev(L[17] - _ny_PrelimFedReturn.fedline[7]) > 0.1)
  {
;    fprintf(outfile, " Warning: L[17] = %6.2f, while Fed-line[7b] = %6.2f\n", L[17], _ny_PrelimFedReturn.fedline[7]);
  }
  ...
  if (absolutev(L[19] - _ny_PrelimFedReturn.fedline[8]) > 0.1)
  {
;    fprintf(outfile, " Warning: L[19] = %6.2f, while Fed-line[8b] = %6.2f\n", L[19], _ny_PrelimFedReturn.fedline[8]);
  }
...
/* END of taxsolve_NY_IT201_2019.c */
/* START of taxsolve_OH_IT1040_2019.c */
double _oh_thisversion = 17.00;
double _oh_TaxRateFunction(double x, int status)
{
  if (x <= 21750.0)
    ...
    if (x < 43450.0)
    return 310.47 + ((x - 21750.0) * 0.02850);
  else
    if (x < 86900.0)
    return 928.92 + ((x - 43450.0) * 0.03326);
  else
    if (x < 108700.0)
    return 2374.07 + ((x - 86900.0) * 0.03802);
  else
    if (x < 217400.0)
    return 3202.91 + ((x - 108700.0) * 0.04413);
  else
    return 7999.84 + ((x - 217400.0) * 0.04797);
...
/* END of taxsolve_OH_IT1040_2019.c */
/* START of taxsolve_PA_40_2019.c */
...
/* END of taxsolve_PA_40_2019.c */
/* START of taxsolve_VA_760_2019.c */
float _va_thisversion = 17.01;
