...
REGRESSION_SCENARIOS = [
    ...
    # NJ regression scenarios
    TaxScenario(
        source="Library baseline (no external validation)",
        description="NJ Single filer, $50,000 W2 income",
        year=2024,
        state="NJ",
        filing_status="Single",
        w2_income=50000.0,
    ...
    TaxScenario(
        source="Library baseline (no external validation)",
        description="NJ Single filer, $75,000 W2 income",
        year=2024,
        state="NJ",
        filing_status="Single",
        w2_income=75000.0,
    ...
    TaxScenario(
        source="Library baseline (no external validation)",
        description="NJ Single filer, $150,000 W2 income",
        year=2024,
        state="NJ",
        filing_status="Single",
        w2_income=150000.0,
    ...
    TaxScenario(
        source="Library baseline (no external validation)",
        description="NJ Married/Joint, $200,000 W2 income",
        year=2024,
        state="NJ",
        filing_status="Married/Joint",
        w2_income=200000.0,
