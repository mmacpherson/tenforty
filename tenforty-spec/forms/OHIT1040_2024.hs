...
ohIT1040_2024 :: Either FormError Form
ohIT1040_2024 = form "oh_it1040" 2024 $ do
    ...
    -- Base tax of $360.69 applies to income above $26,050
    ohBaseTax <-
        interior "oh_base_tax" "ohio_base_tax" $
            ifPos (l9 .-. dollars 26050) (dollars 360.69) (dollars 0)

    l10 <-
        keyOutput "L10" "oh_nonbusiness_tax" "Ohio nonbusiness income tax" $
            bracketTax "oh_brackets_2024" l9 .+. ohBaseTax
