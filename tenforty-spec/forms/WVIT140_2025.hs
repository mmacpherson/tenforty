...
wvIT140_2025 :: Either FormError Form
wvIT140_2025 = form "wv_it140" 2025 $ do
    ...
    l8 <-
        keyOutput "L8" "wv_tax" "West Virginia tax" $
            bracketTax "wv_brackets_2025" l7
    ...
    -- Line 14: 2025 estimated tax payments
    l14 <- keyInput "L14" "estimated_payments" "2025 estimated income tax payments"
