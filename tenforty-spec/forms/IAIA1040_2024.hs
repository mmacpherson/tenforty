...
iaIA1040_2024 :: Either FormError Form
iaIA1040_2024 = form "ia_ia1040" 2024 $ do
    ...
    -- Line 5: Iowa tax from tax rate schedule
    l5 <-
        keyOutput "L5" "ia_tax_from_brackets" "Iowa tax from tax rate schedule" $
            bracketTax "ia_brackets_2024" l4
    ...
    l29 <- keyInput "L29" "estimated_payments" "Estimated and other payments made for tax year 2024"
