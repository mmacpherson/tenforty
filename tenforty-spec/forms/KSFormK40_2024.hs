...
ksFormK40_2024 :: Either FormError Form
ksFormK40_2024 = form "ks_k40" 2024 $ do
    ...
    stdDed <-
        interior "StdDed" "ks_std_deduction" $
            byStatusE (fmap lit ksStandardDeduction2024)
    ...
    l8 <-
        interior "L8" "ks_bracket_tax" $
            bracketTax "ks_brackets_2024" l7
