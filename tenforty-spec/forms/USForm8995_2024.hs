...
usForm8995_2024 = form "us_form_8995" 2024 $ do
  ...
  l5 <- interior "L5" "total_qbi" $
    l1 .+. l2 .+. l3 .+. l4

  -- Line 6: QBI component. Multiply line 5 by 20% (0.20)
  l6 <- interior "L6" "qbi_component" $
