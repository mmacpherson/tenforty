...
usScheduleSE_2025 :: Either FormError Form
usScheduleSE_2025 = form "us_schedule_se" 2025 $ do
  ...
  l3 <- interior "L3" "net_se_earnings" $
    l1a .+. l1b .+. l2

  -- Line 4a: Multiply line 3 by 92.35% (0.9235) - employer-equivalent adjustment
  l4a <- interior "L4a" "adjusted_se_earnings" $
    l3 .*. lit seNetEarningsRate2025
  ...
  l4c <- interior "L4c" "total_se_earnings" $
    max0 (l4a .+. l4b)
