...
mtForm2_2025 :: Either FormError Form
mtForm2_2025 = form "mt_form2" 2025 $ do
    defineTable montanaOrdinaryBracketsTable2025
    defineTable montanaCapitalGainsBracketsTable2025
    ...
    l11 <-
        keyOutput "L11" "mt_capital_gains_tax" "Net long-term capital gains tax" $
            bracketTax "mt_capital_gains_brackets_2025" l2
    ...
    l12 <-
        keyOutput "L12" "mt_ordinary_income_tax" "Montana ordinary income tax" $
            bracketTax "mt_ordinary_brackets_2025" l4
