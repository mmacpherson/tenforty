...
usForm2441_2024 :: Either FormError Form
usForm2441_2024 = form "us_form_2441" 2024 $ do
    ...
    l3 <-
        interior "L3" "expense_limit" $
            ifGte
                l1
                (lit 2)
                (lit dependentCareLimit2Plus2024)
                (lit dependentCareLimit1Person2024)
    ...
    _l9 <-
        interior "L9" "credit_percentage_cents" $
    ...
    _l11 <-
        keyOutput "L11" "dependent_care_credit" "Credit for child and dependent care expenses" l10
    ...
    l14 <-
        interior "L14" "net_employer_benefits" $
    ...
    _l26 <-
        keyOutput "L26" "taxable_benefits" "Taxable dependent care benefits" $
