...
usSchedule2_2024 = form "us_schedule_2" 2024 $ do
    ...
    _l3 <-
        keyOutput "L3" "part1_total" "Add lines 1 and 2" $
            l1 .+. l2
    ...
    _l21 <-
        keyOutput "L21" "total_other_taxes" "Add lines 4 through 8 and 17" l18
