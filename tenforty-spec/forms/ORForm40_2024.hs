...
orForm40_2024 :: Either FormError Form
orForm40_2024 = form "or_40" 2024 $ do
    ...
    stdDed <-
        interior "StdDed" "or_std_deduction" $
            byStatusE (fmap lit orStandardDeduction2024)
    ...
    l25 <-
        keyOutput "L25" "or_bracket_tax" "Tax from Oregon tax rate schedule" $
            bracketTax "or_brackets_2024" l24
