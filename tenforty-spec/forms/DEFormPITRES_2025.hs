...
deFormPITRES_2025 :: Either FormError Form
deFormPITRES_2025 = form "de_pit_res" 2025 $ do
    ...
    stdDed <-
        interior "StdDed" "de_std_deduction" $
            byStatusE (fmap lit deStandardDeduction2025)
    ...
    l22 <-
        interior "L22" "de_bracket_tax" $
            bracketTax "de_brackets_2025" l21
