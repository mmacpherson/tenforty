...
usSchedule1_2025 = form "us_schedule_1" 2025 $ do
    ...
    l9 <-
        interior "L9" "other_income_total" $
            l8a
                .+. l8b
                .+. l8c
                .+. l8d
    ...
    _l10 <-
        keyOutput "L10" "additional_income" "Total additional income" $
    ...
    l25 <-
        interior "L25" "other_adjustments_total" $
            l24a
                .+. l24b
                .+. l24c
                .+. l24d
    ...
    _l26 <-
        keyOutput "L26" "total_adjustments" "Total adjustments to income" $
            l11
                .+. l12
                .+. l13
                .+. l14
