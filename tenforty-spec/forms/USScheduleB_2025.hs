...
usScheduleB_2025 :: Either FormError Form
usScheduleB_2025 = form "us_schedule_b" 2025 $ do
  ...
  l2 <- interior "L2" "total_interest_listed" $
  ...
  _l4 <- keyOutput "L4" "taxable_interest" "Taxable interest (to Form 1040, line 2b)" $
  ...
  _l6 <- keyOutput "L6" "ordinary_dividends" "Ordinary dividends (to Form 1040, line 3b)" $
