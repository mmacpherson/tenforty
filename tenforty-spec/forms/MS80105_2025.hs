...
ms80105_2025 :: Either FormError Form
ms80105_2025 = form "ms_80105" 2025 $ do
    ...
    l14b_std <-
        interior "L14b_std" "standard_deduction" $
            byStatusE (fmap lit msStandardDeduction2025)
    l14b <-
    ...
    -- 0% on first $10,000, then 4.4% on excess (reduced from 4.7% in 2024)
    l17 <-
        keyOutput "L17" "ms_computed_tax" "Computed tax" $
            (l16 `subtractNotBelowZero` lit msTaxThreshold2025) .*. rate msTaxRate2025
