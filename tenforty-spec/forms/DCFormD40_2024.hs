...
dcFormD40_2024 :: Either FormError Form
dcFormD40_2024 = form "dc_d40" 2024 $ do
    ...
    l5 <-
        interior "L5" "dc_standard_deduction" $
            byStatusE (fmap lit dcStandardDeduction2024)
    ...
    l7 <-
        keyOutput "L7" "dc_income_tax" "District of Columbia income tax" $
            bracketTax "dc_brackets_2024" l6
