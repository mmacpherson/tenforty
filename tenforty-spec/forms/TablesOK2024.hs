...
{- | 2024 Oklahoma State income tax brackets
Order: Single, MFJ, MFS, HoH, QW
Source: Oklahoma Tax Commission - 2024 Tax Rate Schedules
https://www.incometaxpro.com/tax-rates/oklahoma.htm
...
-}
okBrackets2024 :: NonEmpty Bracket
okBrackets2024 =
...
okBracketsTable2024 :: Table
okBracketsTable2024 =
    case mkBracketTable okBrackets2024 of
        Right bt -> TableBracket "ok_brackets_2024" bt
        Left err -> error $ "Invalid Oklahoma brackets: " ++ err

{- | 2024 Oklahoma standard deduction by filing status
Source: Oklahoma Tax Commission - 2024 Form 511 Instructions
...
QW: $12,700
-}
okStandardDeduction2024 :: ByStatus (Amount Dollars)
okStandardDeduction2024 =
