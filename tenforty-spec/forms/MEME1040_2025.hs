...
meme1040_2025 :: Either FormError Form
meme1040_2025 = form "me_1040me" 2025 $ do
    ...
    stdDed <-
        interior "StdDed" "me_std_deduction" $
            byStatusE (fmap lit meStandardDeduction2025)
    ...
    l24 <-
        keyOutput "L24" "me_bracket_tax" "Tax from Maine tax rate schedule" $
            bracketTax "me_brackets_2025" l23
