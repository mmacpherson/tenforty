...
nmPIT1_2024 :: Either FormError Form
nmPIT1_2024 = form "nm_pit1" 2024 $ do
    ...
    l18 <-
        keyOutput "L18" "nm_tax" "New Mexico tax" $
            bracketTax "nm_brackets_2024" l17
    ...
    -- Line 30: 2024 estimated income tax payments
    l30 <- keyInput "L30" "estimated_payments" "2024 estimated income tax payments"
    ...
    -- Line 41: Amount applied to 2025 estimated tax
    l41 <- keyInput "L41" "applied_to_next_year" "Amount applied to 2025 estimated tax"
