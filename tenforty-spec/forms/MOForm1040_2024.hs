...
moForm1040_2024 :: Either FormError Form
moForm1040_2024 = form "mo_1040" 2024 $ do
    ...
    stdDed <-
        interior "StdDed" "mo_std_deduction" $
            byStatusE (fmap lit moStandardDeduction2024)
    ...
    l23 <-
        keyOutput "L23" "mo_income_tax" "Missouri income tax" $
            bracketTax "mo_brackets_2024" l22
