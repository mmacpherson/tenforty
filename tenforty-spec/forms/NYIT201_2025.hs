...
nyIT201_2025 :: Either FormError Form
nyIT201_2025 = form "ny_it201" 2025 $ do
    defineTable newYorkBracketsTable2025
    ...
    stdDed <-
        interior "StdDed" "ny_std_deduction" $
            byStatusE (fmap lit nyStandardDeduction2025)
    ...
    l39 <-
        keyOutput "L39" "ny_bracket_tax" "Tax from New York State tax rate schedule" $
            bracketTax "ny_brackets_2025" l38
    ...
    l47a <-
        keyOutput "L47a" "nyc_tax" "NYC resident income tax" $
            bracketTax "nyc_brackets_2025" l47
