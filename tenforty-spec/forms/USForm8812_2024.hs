...
usForm8812_2024 :: Either FormError Form
usForm8812_2024 = form "us_form_8812" 2024 $ do
  ...
  l4 <- interior "L4" "odc_amount" $
    l3 .*. rate 500

  -- Line 5: Add lines 2 and 4
  l5 <- interior "L5" "total_credit_before_limit" $
    l2 .+. l4
  ...
  l7 <- interior "L7" "phaseout_threshold" $
    byStatusE (fmap lit ctcThreshold2024)

  -- Line 8: Subtract line 7 from line 6. If zero or less, enter -0-.
  l8 <- interior "L8" "excess_agi" $
  ...
  _l13 <- interior "L13" "odc_limited" $
    smallerOf l4 l12

  -- Line 14: CTC/ODC credit. Enter on Form 1040, line 19.
  _l14 <- keyOutput "L14" "ctc_odc" "Child tax credit and credit for other dependents (to Form 1040, line 19)" $
    smallerOf l11 l12

  -- Part II-A: Additional Child Tax Credit (Refundable)

  -- Line 15: Subtract line 14 from line 11
  l15 <- interior "L15" "excess_ctc" $
  ...
  l16b <- interior "L16b" "max_actc" $
    l16a .*. rate 1700

  -- Line 17: Enter the smaller of line 15 or line 16b
  l17 <- interior "L17" "actc_limit" $
    smallerOf l15 l16b
  ...
  l18b <- interior "L18b" "earned_income_excess" $
    l18a `subtractNotBelowZero` lit actcEarnedIncomeThreshold2024

  -- Line 19: Multiply line 18b by 15% (0.15)
  l19 <- interior "L19" "actc_earned_income_amount" $
    l18b .*. lit actcEarnedIncomeRate2024
  ...
  _l27 <- keyOutput "L27" "additional_ctc" "Additional child tax credit (to Form 1040, line 28)" $
    smallerOf l17 l19
