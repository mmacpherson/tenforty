...
arAR1000F_2025 :: Either FormError Form
arAR1000F_2025 = form "ar_ar1000f" 2025 $ do
    ...
    l6b_std <-
        interior "L6b_std" "standard_deduction" $
            byStatusE (fmap lit arStandardDeduction2025)
    ...
    l10 <-
        keyOutput "L10" "ar_tax_from_brackets" "Arkansas income tax from tax rate schedule" $
            bracketTax "ar_brackets_2025" l9
