...
vaForm760_2024 :: Either FormError Form
vaForm760_2024 = form "va_760" 2024 $ do
    ...
    l9_std <-
        interior "L9_std" "va_std_deduction" $
            byStatusE (fmap lit vaStandardDeduction2024)
    ...
    l14 <-
        keyOutput "L14" "va_tax" "Virginia income tax" $
            bracketTax "va_brackets_2024" l13
