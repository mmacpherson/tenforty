...
usSchedule3_2024 = form "us_schedule_3" 2024 $ do
    ...
    l7 <-
        interior "L7" "total_other_nonref" $
            l6a .+. l6b .+. l6c .+. l6d .+. l6e .+. l6f .+. l6g .+. l6h .+. l6i .+. l6z

    _l8 <-
        keyOutput "L8" "total_nonrefundable" "Total nonrefundable credits (add lines 1-5 and 7)" $
            l1 .+. l2 .+. l3 .+. l4 .+. l5 .+. l7
    ...
    l14 <-
        interior "L14" "total_other_payments" $
            l13a .+. l13b .+. l13c .+. l13d .+. l13e .+. l13f .+. l13g .+. l13z

    _l15 <-
        keyOutput "L15" "total_other_refundable" "Total other payments and refundable credits (add lines 9-12 and 14)" $
            l9 .+. l10 .+. l11 .+. l12 .+. l14
