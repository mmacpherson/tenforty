...
us1040_2024 :: Either FormError Form
us1040_2024 = form "us_1040" 2024 $ do
  defineTable federalBracketsTable2024
  ...
  l9 <- keyOutput "L9" "total_income" "Total income before adjustments" $
  ...
  l11 <- keyOutput "L11" "agi" "Adjusted gross income (AGI)" $
    l9 .-. l10
  ...
  l25d <- interior "L25d" "total_withholding" $
    l25a .+. l25b .+. l25c
  ...
  l33 <- keyOutput "L33" "total_payments" "Total payments and refundable credits" $
    l25d .+. l26 .+. l27 .+. l28 .+. l29 .+. l30 .+. l31 .+. l32

  -- Line 34: If line 33 is more than line 24, subtract line 24 from line 33.
  l34 <- keyOutput "L34" "overpayment" "Amount overpaid (if payments exceed tax)" $
    l33 `excessOf` l24
  ...
  _l37 <- keyOutput "L37" "amount_owed" "Amount you owe (if tax exceeds payments)" $
    l24 `subtractNotBelowZero` l33

  _l38 <- keyInput "L38" "estimated_penalty" "Estimated tax penalty"

  outputs
    [ "L1z", "L9", "L11", "L14", "L15", "L16", "L18", "L21"
    , "L22", "L24", "L25d", "L33", "L34", "L37"
    ]
