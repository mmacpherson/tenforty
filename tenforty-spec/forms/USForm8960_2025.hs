...
usForm8960_2025 :: Either FormError Form
usForm8960_2025 = form "us_form_8960" 2025 $ do
  ...
  l8 <- keyOutput "L8" "total_investment_income" "Total investment income" $
  ...
  l12 <- keyOutput "L12" "net_investment_income" "Net Investment Income (L8 - L11, not below 0)" $
  ...
  l14 <- interior "L14" "niit_threshold" $
    byStatusE (fmap lit niitThreshold2025)

  l15 <- interior "L15" "excess_over_threshold" $
    l13 `subtractNotBelowZero` l14

  l16 <- interior "L16" "smaller_of_nii_or_excess" $
    smallerOf l12 l15

  _l17 <- keyOutput "L17" "niit" "Net Investment Income Tax (3.8%)" $
    l16 .*. lit 0.038
