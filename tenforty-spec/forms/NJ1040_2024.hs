...
nj1040_2024 = form "nj_1040" 2024 $ do
    ...
    l10 <-
        interior "L10" "dependent_children_exemption" $
            l10_count .*. lit njDependentExemption2024
    ...
    l11 <-
        interior "L11" "other_dependents_exemption" $
            l11_count .*. lit njDependentExemption2024
    ...
    l12 <-
        interior "L12" "dependent_students_exemption" $
            l12_count .*. lit njDependentStudentExemption2024
    ...
    propTaxLimit <-
        interior "PropTaxLimit" "prop_tax_limit" $
            byStatusE (fmap lit njPropertyTaxDeductionLimits2024)
    l41 <-
    ...
    l43 <-
        keyOutput "L43" "nj_tax" "New Jersey income tax" $
            bracketTax "nj_brackets_2024" l42
    ...
    propTaxCredit <-
        interior "PropTaxCredit" "prop_tax_credit" $
            byStatusE (fmap lit njPropertyTaxCredits2024)
  ...
  where
    ...
    njPersonalExemption2024Counts :: ByStatus (Amount Dollars)
    njPersonalExemption2024Counts = byStatus 1000 2000 1000 1000 1000

    -- Property tax deduction limits by status
    njPropertyTaxDeductionLimits2024 :: ByStatus (Amount Dollars)
    njPropertyTaxDeductionLimits2024 = byStatus 15000 15000 7500 15000 15000

    -- Property tax credits by status
    njPropertyTaxCredits2024 :: ByStatus (Amount Dollars)
    njPropertyTaxCredits2024 = byStatus 50 50 25 50 50
