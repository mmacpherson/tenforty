...
ctForm1_2024 :: Either FormError Form
ctForm1_2024 = form "ct_1" 2024 $ do
    ...
    let baseExemption = byStatusE (fmap lit ctPersonalExemptionBase2024)
    let phaseoutThreshold = byStatusE (fmap lit ctPersonalExemptionPhaseoutStart2024)
    ...
    l4 <-
        interior "L4" "ct_initial_tax" $
            bracketTax "ct_brackets_2024" l3
