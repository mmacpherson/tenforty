...
riRI1040_2024 :: Either FormError Form
riRI1040_2024 = form "ri_1040" 2024 $ do
    ...
    l4 <-
        interior "L4" "ri_standard_deduction" $
            byStatusE (fmap lit riStandardDeduction2024)
    ...
    -- Line 6: Personal exemptions ($4,950 per exemption in 2024)
    ...
    l8 <-
        keyOutput "L8" "ri_income_tax" "Rhode Island income tax" $
            bracketTax "ri_brackets_2024" l7
