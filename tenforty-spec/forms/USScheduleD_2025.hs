...
usScheduleD_2025 :: Either FormError Form
usScheduleD_2025 = form "us_schedule_d" 2025 $ do
  ...
  l7  <- keyOutput "L7" "net_short_term" "Net short-term capital gain or loss" $
  ...
  l15 <- keyOutput "L15" "net_long_term" "Net long-term capital gain or loss" $
           sumOf [l8a, l8b, l9, l10, l11, l12, l13, l14]

  -- Part III: Summary
  _l16 <- keyOutput "L16" "net_capital_gain_loss" "Net capital gain or loss" $
           l7 .+. l15
