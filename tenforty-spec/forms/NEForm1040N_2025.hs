...
neForm1040N_2025 :: Either FormError Form
neForm1040N_2025 = form "ne_1040n" 2025 $ do
    ...
    stdDed <-
        interior "L6" "ne_std_deduction" $
            byStatusE (fmap lit nebraskaStandardDeduction2025)
    ...
    -- Line 12: Adjustments increasing federal AGI (from Schedule I line 13)
    -- Note: Line number changed from 10 to 13 in 2025 form
    l12 <- keyInput "L12" "adjustments_increasing_agi" "Adjustments increasing federal AGI from Nebraska Schedule I"

    -- Line 13: Adjustments decreasing federal AGI (from Schedule I line 44)
    -- Note: Line number changed from 39 to 44 in 2025 form
    ...
    l15 <-
        keyOutput "L15" "ne_tax" "Nebraska income tax" $
            bracketTax "ne_brackets_2025" l14
