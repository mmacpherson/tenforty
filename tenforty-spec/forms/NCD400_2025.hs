...
ncd400_2025 :: Either FormError Form
ncd400_2025 = form "nc_d400" 2025 $ do
    defineTable ncChildDeductionTable2025
    ...
    childDedPerChild <- interior "ChildDedPerChild" "child_deduction_per_child" $
        tableLookup "nc_child_deduction_2025" l6
