module TablesNY2025 (
    ...
    newYorkBrackets2025,
    newYorkBracketsTable2025,

    -- * Standard Deduction
    nyStandardDeduction2025,

    -- * Dependent Exemption
    nyDependentExemption2025,

    -- * NYC Income Tax Brackets
    nycBrackets2025,
    nycBracketsTable2025,
) where
...
Source: NY IT-201 Instructions, Tax Rate Schedule
Note: NY does not inflation-adjust brackets; 2025 thresholds are
unchanged from 2024.
-}
newYorkBrackets2025 :: NonEmpty Bracket
newYorkBrackets2025 =
...
newYorkBracketsTable2025 :: Table
newYorkBracketsTable2025 =
    case mkBracketTable newYorkBrackets2025 of
        Right bt -> TableBracket "ny_brackets_2025" bt
        Left err -> error $ "Invalid New York brackets: " ++ err

{- | 2025 New York State standard deduction amounts
Order: Single, MFJ, MFS, HoH, QW
Source: NY IT-201 Instructions
Note: Unchanged from 2024.
-}
nyStandardDeduction2025 :: ByStatus (Amount Dollars)
nyStandardDeduction2025 = byStatus 8000 16050 8000 11200 16050

-- | 2025 New York dependent exemption amount ($1,000 per dependent)
nyDependentExemption2025 :: Amount Dollars
nyDependentExemption2025 = 1000

{- | 2025 New York City income tax brackets
Order: Single, MFJ, MFS, HoH, QW
Source: NY IT-201 Instructions
Note: Unchanged from 2024.
-}
nycBrackets2025 :: NonEmpty Bracket
nycBrackets2025 =
...
nycBracketsTable2025 :: Table
nycBracketsTable2025 =
    case mkBracketTable nycBrackets2025 of
        Right bt -> TableBracket "nyc_brackets_2025" bt
