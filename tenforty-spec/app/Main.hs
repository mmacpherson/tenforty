...
optionsParser =
    Options
        <$> strArgument
            ( metavar "FORM"
                <> help "Form to compile (us_1040_2024, us_1040_2025, us_schedule_1_2024, us_schedule_1_2025, us_schedule_2_2024, us_schedule_2_2025, us_schedule_3_2024, us_schedule_3_2025, us_schedule_a_2024, us_schedule_a_2025, us_schedule_d_2024, us_schedule_d_2025, ca_540_2024, ca_540_2025, ny_it201_2024, ny_it201_2025, all)"
            )
        <*> optional
            ( strOption
                ( long "output"
